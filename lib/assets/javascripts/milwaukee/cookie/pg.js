...
M.provide("cookie.pg", new function () {
  ...
  function namespaced(cookieName) {
    var namespace = "pgcookie.";

    // Check if name is already namespaced if it is don't do it again
    if (cookieName.indexOf(namespace) === 0) {
      return cookieName;
    } else {
      return namespace + cookieName;
    }
  }
